            ...
            encoding
                << position Y
                    ...
                    , pAxis
                        ...
                        , axValues (nums [ -100, -50, 0, 50, 100 ])
                        , axTicks False
                        ]
                    ]
                << color
                    [ mCondition (prParam "mySelection")
                        [ mName "variable", mTitle "Categories" ]
                        [ mStr "grey" ]
                    ]
                << opacity
                    [ mCondition (prParam "mySelection")
...
choropleth_glb =
    let
        glbData =
            dataFromUrl "https://clareho.github.io/dissertation/google_mobility_london_boroughs.csv" []
        ...
        specGlbGP =
            asSpec [ glbData, transGlb [], encGlbGP [], geoshape [] ]

        specGlbPolyGP =
            asSpec
                [ width 250
                , height 200
                , layer [ specGlbGP, specPoly ]
        ...
        specGlbRP =
            asSpec [ glbData, transGlb [], encGlbRP [], geoshape [] ]

        specGlbPolyRP =
            asSpec
                [ width 250
                , height 200
                , layer [ specGlbRP, specPoly ]
        ...
        specGlbR =
            asSpec [ glbData, transGlb [], encGlbR [], geoshape [] ]

        specGlbPolyR =
            asSpec
                [ width 250
                , height 200
                , layer [ specGlbR, specPoly ]
        ...
        specGlbW =
            asSpec [ glbData, transGlb [], encGlbW [], geoshape [] ]

        specGlbPolyW =
            asSpec
                [ width 250
                , height 200
                , layer [ specGlbW, specPoly ]
        ...
        specGlbTS =
            asSpec [ glbData, transGlb [], encGlbTS [], geoshape [] ]

        specGlbPolyTS =
            asSpec
                [ width 250
                , height 200
                , layer [ specGlbTS, specPoly ]
        ...
        specGlbP =
            asSpec [ glbData, transGlb [], encGlbP [], geoshape [] ]

        specGlbPolyP =
            asSpec
                [ width 250
                , height 200
                , layer [ specGlbP, specPoly ]
        ...
        specGlbPolyV1 =
            asSpec [ res [], vConcat [ specGlbPolyGP, specGlbPolyP, specGlbPolyR ] ]

        specGlbPolyv2 =
            asSpec [ res [], vConcat [ specGlbPolyRP, specGlbPolyTS, specGlbPolyW ] ]

        specGlbPolyAll =
            asSpec [ res [], hConcat [ specGlbPolyV1, specGlbPolyv2 ] ]
        ...
        colorStr =
            categoricalDomainMap
                [ ( "Stringency Index", "rgb(195,155,211)" )
                , ( "inverted_index", "rgb(255,255,255)" )
                ]
        ...
        specStrPie =
            asSpec [ arc [ maInnerRadius 30, maOuterRadius 70 ] ]
        ...
        specPieLabel =
            asSpec [ encPieLabel [], textMark [ maRadius 80 ] ]
        ...
        specStrBar =
            asSpec [ width 200, height 50, encStrBar [], dataStrBar, transStrBar [], bar [] ]

        -- Covid cases bar chart
        casesBarData =
            dataFromUrl "https://clareho.github.io/dissertation/region_2022-07-06_london_cases_format.csv" []
        ...
        encNewCasesBar =
            encoding
                << position Y
                    [ pName "New Cases"
                    , pScale [ scDomain (doNums [ 0, 40000 ]) ]
                    , pQuant
                    , pAxis
                        [ axTicks False
                        , axGrid False
        ...
        specNewCasesBar =
            asSpec [ width 80, height 150, encNewCasesBar [], casesBarData, transCasesBar [], bar [] ]

        specDeathCasesBar =
            asSpec [ width 80, height 150, encDeathCasesBar [], casesBarData, transCasesBar [], bar [] ]

        specCasesBar =
            asSpec [ hConcat [ specNewCasesBar, specDeathCasesBar ] ]

        specStrCases =
            asSpec [ hConcat [ specStrPieInt, specCasesBar ], res [] ]
